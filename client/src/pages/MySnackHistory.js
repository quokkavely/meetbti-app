...
const HistorySection = () => {
    ...
    const fetchHistoryData = useCallback(async () => {
        // 데이터를 가져오는 API 호출
        const response = await fetch(`/api/my-snack-history?page=${page}`);
    ...
    const dummyData = [
        { title: '첫 번째 이미지게임', date: '2023-01-01 12:00' },
        { title: '두 번째 밸런스게임', date: '2023-01-02 13:00' },
        { title: '세 번째 이미지게임', date: '2023-01-03 14:00' },
        { title: '네 번째 밸런스게임', date: '2023-01-04 15:00' },
        { title: '다섯 번째 이미지게임', date: '2023-01-05 16:00' },
        { title: '여섯 번째 밸런스게임', date: '2023-01-06 17:00' },
        { title: '일곱 번째 이미지게임', date: '2023-01-06 17:00' },
        { title: '여덟 번째 밸런스게임', date: '2023-01-06 17:00' },
    ];
